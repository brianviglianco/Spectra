...
class SpectralCrawler {
        ...
        try {
            ...
            const scriptAnalysis = await this.page.evaluate(() => {
                ...
                const necessaryDomains = [
                    ...
                    'cookiebot.com', 'cookieinformation.com', // Cookiebot
    ...
    async clickCMPButton(action) {
        ...
        // Try clicking iframe content for SourcePoint/Cookiebot
        ...
        // Fallback to text-based search (multilingual)
        const found = await this.page.evaluate((actionType) => {
            ...
            const textPatterns = {
                ...
                reject: [
                    ...
                    // Danish  
                    'tillad udvalgte', 'afvis alle', 'kun nødvendige'
                ]
            };
    ...
    async analyzeBanner() {
        const bannerInfo = await this.page.evaluate(() => {
            ...
            const hasAccept = buttonTexts.some(text => 
                ...
                text.includes('tillad alle') // Danish
            );
            const hasReject = buttonTexts.some(text => 
                ...
                text.includes('tillad udvalgte') || text.includes('kun nødvendige') // Danish
            );
            const hasSettings = buttonTexts.some(text => 
                ...
                text.includes('indstillinger') // Danish
            );
